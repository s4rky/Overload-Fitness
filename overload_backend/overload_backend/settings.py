"""
Django settings for overload_backend project.
...
SECRET_KEY = "django-insecure-6dgr0+=($w01r+x=2=mbkh3j!pbh^b+$5m#hm^ltk99&#vtzwy"
...
ROOT_URLCONF = "overload_backend.urls"
...
WSGI_APPLICATION = "overload_backend.wsgi.application"
